SCENE_DIR="../../../gsplat/examples/data/zipnerf"
# SCENE_LIST="nyc alameda berlin london"
SCENE_LIST="nyc"
DATA_FACTOR=4
RENDER_TRAJ_PATH="ellipse"

RESULT_DIR="results/benchmark_mcmc_1M_zipnerf_3dgut_with_distortion"
CAP_MAX=1000000
...
do
    ...
    CUDA_VISIBLE_DEVICES=0 python simple_trainer.py mcmc  --eval_steps -1 --disable_viewer --data_factor $DATA_FACTOR \
        --with_eval3d --with_ut --ut_sampling_method cubature --no_process_to_perfect_camera \
